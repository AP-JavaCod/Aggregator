...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Aggregator<String, Integer> sumAggregator = FunctionAggregator.crate(sumFunction);
        Aggregator<String, Integer> sumFilterAggregator = FunctionAggregator.crate(sumFilterFunction);
